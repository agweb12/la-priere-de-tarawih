...
<section id="accueil" class="container-fluid">
    <div class="row-accueil">
        <div class="box-container">
            ...
            <p>Merci pour votre mail ! Nous vous enverrons d'autres types de recherches !</p>
            <p>Vous pouvez télécharger le livre ci-dessous !</p>
            <a href="La-priere-de-Tarawih.pdf" target="_blank" download="La-priere-de-Tarawih.pdf"><button class="primary">Télécharger</button></a>
